        ...
        <SafeAreaView style={{ backgroundColor: "#E8F1F2" }} >
            ...
            <View style={{
                ...
                <View style={[styles.temaContainer, { flexDirection: "column" }]}>
                    ...
                    <TextInput placeholder="Título notificación" placeholderTextColor='grey' style={styles.input} onChangeText={setTituloNotificacion} value={tituloNotificacion} autoCapitalize='none'/>
