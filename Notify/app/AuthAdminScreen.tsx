...
const AuthAdminScreen = () => {
    ...
    return(
        ...
        >
            ...
            <TextInput placeholder="Correo electrónico" placeholderTextColor='grey' style={styles.input} />

            <Text style={styles.titleInput}>Contraseña:</Text>
            <TextInput placeholder="Contraseña" placeholderTextColor='grey' style={styles.input} />
